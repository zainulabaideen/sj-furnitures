...
const ResetPassword = () => {
  ...
  return (
    ...
    <Fragment>
      {
        loading ? <Loader /> : <section className="flex items-center justify-center h-auto md:h-screen md:mt-0 mt-20 px-3">
          <div className="w-full max-w-md mt-10 bg-white rounded-xl shadow-lg p-8">
