...
export default function Testimonial() {
  ...
  return (
    <section
      ...
      data-aos="fade-up"
      className="md:mx-20 mx-3 md:py-10 py-16 px-3 md:px-20 bg-gray-50 mt-10 text-center rounded-3xl"
    >
      {/* Section Header */}
      <header>
      ...
      {/* Testimonials List */}
      <ul
        className="grid grid-cols-1 lg:grid-cols-2 gap-10 justify-center items-start transition-all"
        role="list"
      >
